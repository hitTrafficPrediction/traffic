import sys
import time
from utils.api import next_day, make_prediction_fourier
...
def main(state, custom_day):
    ...
    for section_id in sections:
        ...
        result_up, result_down = make_prediction_fourier(section_id, input_data_up, input_data_down)
