from utils.api import make_prediction, read_local_data, show_img, next_time_minutes
from utils.time_processor import get_current_proximity_time_str
from utils.db_operator import write15min_data, get15min_data
...
def main(state, custom_time):
    ...
    if custom_time is None:
        # 再往前1hour, 确保数据可获得性
        custom_time = next_time_minutes(get_current_proximity_time_str(), -15)
